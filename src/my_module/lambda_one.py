...
def lambda_handler(event, context):
    ...
    xray_subsegment.put_annotation('application', 'lambda-test')
    xray_subsegment.put_metadata('event', event, 'lambda-test')
    ...
    try:
        ...
        subsegment.put_metadata('message', message, 'lambda-test')
